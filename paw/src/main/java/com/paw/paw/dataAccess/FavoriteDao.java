...
public interface FavoriteDao extends JpaRepository<Favorite,Integer> {
  ...
  @Query(value = "Select new com.paw.paw.entities.dtos.FavoriteForFavListDto(fav.id,ad.id,ad.images,ad.name,ad.gender,ad.genus,ca.category,ad.age,ad.city) From Favorite as fav inner join Advert as ad on ad.id = fav.advertid inner join Category as ca on ca.id = ad.categoryid where fav.userid =:userId")
